...
export default async function OrganizationSettingsPage({
  ...
  const {
    ...
    logoUrl,
    settings,
  } = await getUserOrganizationContext(session.user.id, tenant);
  ...
  const autoAcceptDomainSettings = (settings?.autoAcceptDomainMembers as
  ...
  return (
    <div className="space-y-6">
      ...
      <Link href={`/${tenant}/settings/integrations`} className="block">

...
export function OrgTimeline({ data }: OrgTimelineProps) {
  ...
  return (
    <section className="space-y-4">
      <div>
        <h2 className="text-lg font-medium">{t('dashboard.orgTimeline.title')}</h2>
            ...
            <ComposedChart data={data}>
              ...
              <Tooltip
                ...
                formatter={(value, name) => {
                  ...
                  if (name === 'commits') return [v.toFixed(0), t('dashboard.orgTimeline.commits')];
                  if (name === 'stabilization')
                    return [`${(v * 100).toFixed(0)}%`, t('dashboard.orgTimeline.stabilization')];
                  if (name === 'aiPct')
                    return [`${v.toFixed(0)}%`, t('dashboard.orgTimeline.aiAdoption')];
              ...
              <Line
                ...
                stroke="var(--color-signal-purple)"
                strokeWidth={2}
                dot={{ r: 2 }}
                connectNulls
              />

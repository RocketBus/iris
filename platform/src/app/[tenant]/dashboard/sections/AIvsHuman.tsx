...
export function AIvsHuman({ data, tenantSlug }: AIvsHumanProps) {
  ...
  return (
    <section className="space-y-4">
      <div>
        <h2 className="text-lg font-medium">{t('dashboard.aiVsHuman.title')}</h2>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <AreaChart data={data.commitMix}>
                ...
                <Area
                  ...
                  stackId="1"
                  fill="var(--color-signal-gray)"
                  fillOpacity={0.2}
                  stroke="var(--color-signal-gray)"
                  strokeWidth={1}
                />
              </AreaChart>
            </ResponsiveContainer>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>{t('dashboard.aiVsHuman.qualityComparisonTitle')}</CardTitle>
            <CardDescription>
          ...
          {data.toolBreakdown.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>{t('dashboard.aiVsHuman.toolsSubtitle')}</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={Math.max(data.toolBreakdown.length * 32, 80)}>
                  <BarChart
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      itemStyle={{ color: 'var(--muted-foreground)' }}
                      formatter={(v) => [
                        t('dashboard.aiVsHuman.toolsTooltip', { count: Number(v) }),

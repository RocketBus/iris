                ...
                return (
                  <div key={key} className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      <div className={cn('size-2 rounded-full', intentColors[key])} />
                      <span className="text-muted-foreground">{intentLabels[key]}</span>
                    </div>
        ...
        {data.timeline.length >= 2 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('dashboard.intent.intentTrendSubtitle')}</CardDescription>
            </CardHeader>
            <CardContent>

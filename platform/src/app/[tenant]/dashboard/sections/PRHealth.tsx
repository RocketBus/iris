    ...
    <section className="space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          ...
          delta={data.totalPRsMergedDelta}
          deltaFormat="abs"
          neutral
        />
        <MetricCard
          ...
          delta={data.medianTimeToMergeHoursDelta}
          deltaFormat="abs"
          invertDelta
        />
        <MetricCard
          ...
          delta={data.singlePassRateDelta}
          deltaFormat="pp"
        />
        <MetricCard
          ...
          delta={data.medianReviewRoundsDelta}
          deltaFormat="abs"
          invertDelta
        />
      </div>
                ...
                <thead>
                  <tr className="border-b border-border text-left text-muted-foreground">
                    <th className="pb-2 pr-4">
                      {t("dashboard.prHealth.origin")}
                    </th>
                    <th className="pb-2 pr-4">
                      {t("dashboard.prHealth.singlePassRate")}
                    </th>
                    <th className="pb-2">
                      {t("dashboard.prHealth.reviewRounds")}
                    </th>
                  </tr>
                </thead>
                <tbody>

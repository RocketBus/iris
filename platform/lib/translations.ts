  ...
  'en-US': {
    ...
    home: {
      hero: {
        ...
        description: 'Measure what survives, not what ships. Iris analyzes your Git repos and reveals whether AI is making your code more durable — or just more. Detects Copilot, Claude, Cursor, Windsurf, and other AI tools automatically.',
      ...
      problem: {
        ...
        description: 'Your team adopted AI coding tools. Commits increased. PRs are faster. Traditional metrics say things are great. But you can\'t see what\'s breaking underneath.',
      ...
      provenData: {
        ...
        description: 'Validated on an organization with 58 repos, 3,497 commits, and 1,211 merged PRs.',
      ...
      howItWorks: {
        ...
        runLabel: '2. Run',
        readLabel: '3. Read',
        readDescription: 'Get a Markdown report + JSON metrics with delivery pulse, churn investigation, and AI impact analysis.',
        prLabel: 'Optional: Review PRs',
        prDescription: 'Analyze any PR for AI composition, churn risk, and cascade risk. Posts insights as a PR comment.',
      },
      modules: {
        ...
        items: {
          originClassifier: 'Human / AI-Assisted / Bot attribution by tool (Copilot, Claude, Cursor, Windsurf)',
    ...
    faqPage: {
      ...
      subtitle: 'Everything you need to know about Iris. Can\'t find what you\'re looking for?',
      questions: {
        whatIsTitle: 'What does Iris measure?',
        whatIsAnswer: 'Iris analyzes your Git history to surface delivery-quality signals: stabilization, code durability, fix cascades, attribution gaps, and AI impact. Reports are point-in-time, not live monitoring.',
        howWorksTitle: 'How does the analysis work?',
        howWorksAnswer: 'Run the CLI against any repo. It reads commits, PRs and code-survival data locally and produces a Markdown report + JSON metrics. Zero dependencies on cloud services for the engine itself.',
        aiToolsTitle: 'Which AI tools does it detect?',
        aiToolsAnswer: 'Copilot, Claude, Cursor, Windsurf, and other AI assistants are detected via commit metadata, co-author trailers and velocity patterns. New tools can be added via the prepare-commit-msg hook.',
        privacyTitle: 'Does Iris read my code?',
        privacyAnswer: 'The engine runs locally and only inspects Git metadata and diffs. Nothing leaves your machine unless you connect to the optional cloud platform for cross-repo aggregation.',
        individualsTitle: 'Does it rank or score developers?',
        individualsAnswer: 'No. Iris is explicitly designed to analyze systems, never individuals. There is no productivity ranking, no per-author leaderboard, and no individual scoring.',
        platformTitle: 'What does the cloud platform add?',
        platformAnswer: 'The platform aggregates metrics across repos and over time, offers org-wide dashboards, change detection, and cross-repo comparison. The CLI alone is fully usable without it.',
        installTitle: 'How do I install it?',
        installAnswer: 'Run the install script (curl -fsSL https://iris.clickbus.com/install.sh | sh) or pipx install iris. Requires Python 3.11+ and Git.',
        priceTitle: 'How much does it cost?',
        priceAnswer: 'The CLI is free and open. The cloud platform is in early access with usage-based pricing — contact us for details.',
        contributeTitle: 'How can I contribute or report issues?',
        contributeAnswer: 'The project is on GitHub at RocketBus/clickbus-iris. Issues and PRs are welcome.',
      },
    },
    setupLinked: {
    ...
    selectGitHubOrg: {
      ...
      subtitle: 'We\'ll create your Iris workspace mirroring this GitHub org. You can add more later.',
      loading: 'Loading your GitHub organizations...',
      empty: 'You don\'t have any GitHub organizations Iris can see. You can create a workspace manually.',
      manual: 'Create a workspace manually instead',
      noLink: 'You\'re not signed in with GitHub. Sign in with GitHub to use this flow.',
      error: 'Couldn\'t fetch your GitHub organizations. Try again or fall back to manual setup.',
      select: 'Continue',
    },
    welcomeGuide: {
      title: 'First 15 minutes with Iris',
      subtitle: 'A short read so you know what you\'re looking at — and what you\'re not.',
      whatItMeasures: {
        title: 'What Iris measures',
        item1: 'Stabilization — does the code that ships actually persist, or get rewritten?',
        item2: 'AI impact — durability, cascades and acceptance, broken down by AI vs human commits.',
        item3: 'Delivery shape — intent mix, PR health, churn hotspots, attribution gaps.',
      },
      whatItIsNot: {
        title: 'What it is not',
        item1: 'Not a productivity tracker — there is no individual ranking or score.',
        item2: 'Not a real-time monitor — reports are point-in-time, not live alerts.',
      ...
      steps: {
        ...
        step2Desc: 'Use the CLI to push your first analysis. The /connect page in any org walks you through it.',
        step3Title: 'Read your first dashboard',
        step3Desc: 'Once data lands, the org dashboard surfaces health, AI vs human, and the views below.',
      },
      whereToLook: {
        title: 'Where to look first',
        intro: 'These are the highest-signal views once you have data:',
        shadowAI: 'Shadow AI Exposure — commits that look AI-generated but aren\'t attributed.',
        adoption: 'AI Delivery Timeline — what changed after AI adoption began.',
        healthMap: 'Health Map — which repos are rewriting more than they ship.',
      },
      footer: 'Everything here treats your codebase as the system under study, never individuals. See CLAUDE.md and docs/PRINCIPLES.md if you want the deeper rationale.',
    ...
    meAiUsage: {
      title: 'Your AI usage',
      subtitle: 'A quiet self-reflection on your own commit patterns. Only you see this page.',
      noOrgs: 'You\'re not part of any organization yet. Join one to see your data here.',
      noMatch: 'We couldn\'t match your name ({name}) against any commit author across your organizations. If you commit under a different name in Git, this view will populate once you sync.',
      privacyNote: 'This page is strictly self-only. There is no ranking, no comparison with peers, and no admin can open it for someone else.',
      summary: {
      ...
      coverageNote: 'Tool-level and intent-level breakdowns per author aren\'t in the engine yet. When they are, this page will pick them up automatically.',
    },
    roles: {
      owner: 'Owner',
      admin: 'Admin',
    ...
    dashboard: {
      ...
      quality: {
        ...
        distributionSubtitle: 'Per-repo stabilization ratio — dispersion across the org',
      ...
      aiVsHuman: {
        ...
        attributionGapDescription: '{flagged} of {total} human commits show AI-like patterns but lack attribution',
        attributionGapCta: 'See Shadow AI Exposure →',
      },
      intent: {
        title: 'Intent Distribution',
        subtitle: 'What kind of changes are being made across {count} repositories',
      ...
      hyperEngineers: {
        ...
        subtitle: 'Contributors with high velocity or 80%+ AI adoption across the org',
    ...
    investHere: {
      ...
      subtitle: 'Systemic patterns that drive the most rework in this repository.',
      empty: 'No systemic hotspots detected. Stabilization, coupling and fix distribution all look within healthy ranges.',
      severityHigh: 'High',
      severityMedium: 'Medium',
      severityLow: 'Low',
      weakDirectoryTitle: 'Weak directory: {directory}',
      weakDirectoryReason: 'Code here stabilizes at {ratio}% across {files} files touched. The directory absorbed {churn} churn events — rework concentrates here.',
      tightCouplingTitle: 'Tight coupling',
      tightCouplingReason: '{fileA} and {fileB} change together {rate}% of the time ({count} joint changes). Decoupling would reduce rework cost across the area.',
      fixMagnetTitle: '{origin} attracts fixes',
      fixMagnetReason: 'Commits from {origin} represent {codeShare}% of changes but {fixShare}% of fixes ({disp}× the baseline, {count} fixes in window). Review patterns may need adjustment for this origin.',
      hypothesisNote: 'These are systemic hypotheses derived from commit history. They point to where attention may reduce rework, not to who is responsible.',
    },
    adoption: {
      title: 'AI Delivery Timeline',
      subtitle: 'What changed in this repository after AI-assisted commits began.',
      orgTitle: 'AI Delivery Timeline',
      orgSubtitle: 'Repositories where AI adoption was detected and how delivery quality shifted since.',
      orgEmpty: 'No AI adoption events detected yet across this organization.',
      empty: 'No AI adoption event detected. Install the Iris hook or commit with AI attribution to surface this view.',
      insufficient: 'Collecting data: {count} AI commits seen so far (need at least 5 to analyze pre/post deltas).',
      detected: 'AI adoption detected on {date} ({count} AI commits)',
      hypothesisNote: 'Deltas compare pre-adoption and post-adoption windows. Correlation, not causation — other changes may have overlapped.',
      confidence: {
        clear: 'Clear',
        sparse: 'Sparse',
    ...
    toolComparison: {
      ...
      subtitle: 'Quality signals side-by-side across AI tools used in your codebase.',
      columnTool: 'Tool',
      ...
      thresholdNote: 'Rows with fewer than {threshold} commits are marked as low-confidence and sorted to the bottom.',
      noSignificant: 'No tool has enough commits yet to produce a meaningful comparison (minimum {threshold}).',
    },
    connect: {
      title: 'Connect your first repository',
      subtitle: 'Get your first insight in under 5 minutes. Three short commands from your terminal.',
      alreadyConnected: 'You already have {count} {repoLabel} connected. You can still add more from the CLI.',
    ...
    repos: {
      ...
      deleteDialog: {
        ...
        description: 'This will permanently delete the repository {name} and all of its analysis runs and metrics. This action cannot be undone.',
        warning: 'Deleting a repository is irreversible. All historical runs, metrics, and insights for this repository will be permanently removed.',
      ...
      detail: {
        ...
        contributorsCountPlural: '{count} contributors in the last analysis window',
    ...
    aiExposure: {
      ...
      subtitle: 'How much AI-assisted code is being produced — and how much is attributed.',
      empty: 'No origin data yet. Run the CLI on a repository to start measuring.',
      summary: {
        attributed: 'Attributed AI',
        attributedHint: 'Commits with an AI co-author trace (e.g. Copilot, Claude, Cursor)',
        estimated: 'Estimated AI',
        estimatedHint: 'Upper-bound: attributed commits plus human commits that match AI-like patterns',
        gap: 'Shadow AI gap',
        gapHint: 'Percentage points between estimated and attributed. Higher means more likely hidden AI.',
        baseline: '{flagged} of {total} human commits match ≥2 AI-like signals (burst, large diff, rapid succession, wide spread).',
        noSignal: 'No shadow signal detected across repositories. Attribution coverage reflects the real AI usage captured in commit history.',
      },
      table: {
      ...
      install: {
        ...
        description: 'Install the Iris prepare-commit-msg hook on {name} so AI-authored commits get co-author attribution going forward.',
      ...
      hypothesisNote: 'These numbers are hypotheses, not truths. The shadow signal flags commits that match patterns seen in AI-assisted work; it does not prove AI authorship.',
    },
    team: {
      title: 'Team',
    ...
    setup: {
      ...
      errorGithubOrgTaken: 'This GitHub organization is already linked to a Iris workspace you are not a member of. Ask an existing member to invite you.',
    },
    auditLog: {
      title: 'Audit Log',
    ...
    security: {
      ...
      password: {
        ...
        dialogDescription: 'Enter your current password and choose a new secure password',
    ...
    account: {
      ...
      danger: {
        ...
        confirmRequired: 'Please confirm that you understand this action is irreversible',
        errorGeneric: 'Failed to delete account',
        success: 'Account deleted successfully',
        ownerWarning: 'You cannot delete your account while you are an owner of one or more organizations. Please transfer ownership to another member first.',
      },
    },
    auth: {
      signin: {
    ...
    acceptInvite: {
      ...
      fallback: {
        ...
        description: 'We are preparing your invitation details. Hold on a moment.',
      },
      errors: {
  ...
  'pt-BR': {
    ...
    home: {
      hero: {
        ...
        description: 'Meça o que sobrevive, não o que é entregue. O Iris analisa seus repositórios Git e revela se a IA está tornando seu código mais durável — ou apenas em maior volume. Detecta Copilot, Claude, Cursor, Windsurf e outras ferramentas de IA automaticamente.',
        ctaPrimary: 'Começar',
      ...
      problem: {
        ...
        description: 'Seu time adotou ferramentas de IA. Os commits aumentaram. Os PRs estão mais rápidos. As métricas tradicionais dizem que está tudo ótimo. Mas você não consegue ver o que está quebrando por baixo.',
      ...
      provenData: {
        ...
        description: 'Validado em uma organização com 58 repos, 3.497 commits e 1.211 PRs mesclados.',
        stat1Label: 'estabilização do código de IA vs código humano',
        stat2Label: 'dos commits "humanos" batem com padrões de velocidade de IA',
      ...
      howItWorks: {
        ...
        runLabel: '2. Rodar',
        readLabel: '3. Ler',
        readDescription: 'Receba um relatório em Markdown + métricas em JSON com pulso de entrega, investigação de churn e análise de impacto de IA.',
        prLabel: 'Opcional: revisar PRs',
        prDescription: 'Analise qualquer PR quanto a composição de IA, risco de churn e risco de cascata. Posta os insights como comentário no PR.',
      },
      modules: {
        ...
        items: {
          originClassifier: 'Atribuição Humano / Assistido por IA / Bot por ferramenta (Copilot, Claude, Cursor, Windsurf)',
          codeDurability: 'Taxa de sobrevivência de linhas por origem e ferramenta',
          correctionCascades: 'Padrões de correções em cadeia por origem e ferramenta',
          ...
          churnInvestigation: 'Detecção de cadeias e acoplamento entre arquivos',
      ...
      cta: {
        ...
        description: 'Um comando. Roda localmente. Plataforma na nuvem é opcional.',
        copy: 'Copiar',
        copied: 'Copiado!',
    ...
    faqPage: {
      ...
      subtitle: 'Tudo que você precisa saber sobre o Iris. Não encontrou o que procurava?',
      questions: {
        whatIsTitle: 'O que o Iris mede?',
        whatIsAnswer: 'O Iris analisa seu histórico Git para revelar sinais de qualidade de entrega: estabilização, durabilidade do código, cascatas de correção, lacunas de atribuição e impacto da IA. Os relatórios são pontuais, não monitoramento ao vivo.',
        howWorksTitle: 'Como funciona a análise?',
        howWorksAnswer: 'Rode o CLI em qualquer repo. Ele lê commits, PRs e dados de sobrevivência de código localmente e gera um relatório em Markdown + métricas em JSON. O motor não depende de serviços em nuvem.',
        aiToolsTitle: 'Quais ferramentas de IA ele detecta?',
        aiToolsAnswer: 'Copilot, Claude, Cursor, Windsurf e outras assistentes são detectadas via metadados dos commits, trailers de co-autor e padrões de velocidade. Novas ferramentas podem ser adicionadas via hook prepare-commit-msg.',
        privacyTitle: 'O Iris lê meu código?',
        privacyAnswer: 'O motor roda localmente e só inspeciona metadados Git e diffs. Nada sai da sua máquina, a não ser que você conecte a plataforma na nuvem opcional para agregação entre repos.',
        individualsTitle: 'Faz ranking ou score de devs?',
        individualsAnswer: 'Não. O Iris é explicitamente desenhado para analisar sistemas, nunca indivíduos. Não há ranking de produtividade, leaderboard por autor nem score individual.',
        platformTitle: 'O que a plataforma na nuvem agrega?',
        platformAnswer: 'A plataforma agrega métricas entre repos e ao longo do tempo, oferece dashboards no nível de organização, detecção de mudanças e comparação entre repos. O CLI sozinho é totalmente utilizável sem ela.',
        installTitle: 'Como instalo?',
        installAnswer: 'Rode o script de instalação (curl -fsSL https://iris.clickbus.com/install.sh | sh) ou pipx install iris. Requer Python 3.11+ e Git.',
        priceTitle: 'Quanto custa?',
        priceAnswer: 'O CLI é gratuito e aberto. A plataforma na nuvem está em acesso antecipado com preço por uso — entre em contato para mais detalhes.',
        contributeTitle: 'Como posso contribuir ou reportar problemas?',
        contributeAnswer: 'O projeto está no GitHub em RocketBus/clickbus-iris. Issues e PRs são bem-vindos.',
      },
    },
    setupLinked: {
    ...
    selectGitHubOrg: {
      ...
      subtitle: 'Vamos criar seu workspace Iris espelhando essa org do GitHub. Dá pra adicionar mais depois.',
      loading: 'Carregando suas organizações do GitHub...',
      empty: 'Você não tem organizações do GitHub que o Iris consiga ver. Pode criar um workspace manualmente.',
      manual: 'Criar um workspace manualmente',
      noLink: 'Você não está autenticado com GitHub. Entre com GitHub para usar este fluxo.',
      error: 'Não conseguimos buscar suas organizações do GitHub. Tente de novo ou caia no setup manual.',
      select: 'Continuar',
    },
    welcomeGuide: {
      title: 'Primeiros 15 minutos com o Iris',
      subtitle: 'Uma leitura curta para você saber o que está vendo — e o que não está.',
      whatItMeasures: {
        title: 'O que o Iris mede',
        item1: 'Estabilização — o código que entra realmente persiste, ou é reescrito?',
        item2: 'Impacto da IA — durabilidade, cascatas e aceitação, separados por IA vs humano.',
        item3: 'Forma da entrega — mix de intenção, saúde de PRs, hotspots de churn, lacunas de atribuição.',
      },
      whatItIsNot: {
        title: 'O que ele não é',
        item1: 'Não é um rastreador de produtividade — não há ranking ou score individual.',
        item2: 'Não é monitoramento em tempo real — relatórios são pontuais, não alertas ao vivo.',
        item3: 'Não é plugin de IDE — o Iris lê o histórico do Git, e nada além disso.',
      },
      steps: {
        ...
        step2Desc: 'Use o CLI para subir sua primeira análise. A página /connect em qualquer org te guia pelo processo.',
        step3Title: 'Ler seu primeiro dashboard',
        step3Desc: 'Quando os dados chegarem, o dashboard da org mostra saúde, IA vs humano, e as visões abaixo.',
      },
      whereToLook: {
        title: 'Onde olhar primeiro',
        intro: 'Estas são as visões com maior sinal assim que houver dados:',
        shadowAI: 'Exposição a IA Sombra — commits que parecem gerados por IA mas não têm atribuição.',
        adoption: 'Linha do tempo da IA — o que mudou depois que a adoção da IA começou.',
        healthMap: 'Mapa de saúde — quais repos estão reescrevendo mais do que entregando.',
      },
      footer: 'Tudo aqui trata sua base de código como o sistema sob estudo, nunca os indivíduos. Veja CLAUDE.md e docs/PRINCIPLES.md se quiser o racional mais profundo.',
    ...
    meAiUsage: {
      title: 'Seu uso de IA',
      subtitle: 'Uma autorreflexão tranquila sobre seus próprios padrões de commit. Só você vê esta página.',
      noOrgs: 'Você ainda não faz parte de nenhuma organização. Entre em uma para ver seus dados aqui.',
      noMatch: 'Não conseguimos casar seu nome ({name}) com nenhum autor de commit nas suas organizações. Se você comita com outro nome no Git, esta visão vai aparecer assim que sincronizar.',
      privacyNote: 'Esta página é estritamente pessoal. Não há ranking, comparação com pares e nenhum admin consegue abri-la para outra pessoa.',
      summary: {
      ...
      coverageNote: 'Detalhamento por ferramenta e por intenção, no nível de autor, ainda não está no motor. Quando estiver, esta página vai puxar automaticamente.',
    },
    navigation: {
      dashboard: 'Dashboard',
    ...
    dashboard: {
      ...
      quality: {
        ...
        distributionSubtitle: 'Razão de estabilização por repo — dispersão na organização',
      ...
      aiVsHuman: {
        title: 'IA vs Humano',
        subtitle: 'Como o código assistido por IA se compara em {count} repositórios',
        commitMixTitle: 'Mix de commits',
        commitMixSubtitle: 'Commits humanos vs assistidos por IA ao longo do tempo (organização)',
        human: 'Humano',
        ai: 'Assistido por IA',
        bot: 'Bot',
        ...
        attributionGapDescription: '{flagged} de {total} commits humanos mostram padrões de IA mas não têm atribuição',
        attributionGapCta: 'Ver Exposição a IA Sombra →',
      },
      intent: {
        title: 'Distribuição de intenção',
        subtitle: 'Que tipos de mudanças estão sendo feitas em {count} repositórios',
      ...
      healthMap: {
        title: 'Mapa de saúde',
        subtitle: 'Tamanho do repositório por commits, colorido por estabilização',
      ...
      hyperEngineers: {
        title: 'Hyper Engineers',
        subtitle: 'Contribuidores com alta velocidade ou 80%+ de adoção de IA na organização',
        badge: 'Hyper Engineer',
        repos: '{count} repos',
      },
      repoList: {
    ...
    investHere: {
      title: 'Onde investir',
      subtitle: 'Padrões sistêmicos que geram mais retrabalho neste repositório.',
      empty: 'Nenhum hotspot sistêmico detectado. Estabilização, acoplamento e distribuição de fixes estão dentro de faixas saudáveis.',
      severityHigh: 'Alto',
      severityMedium: 'Médio',
      severityLow: 'Baixo',
      weakDirectoryTitle: 'Diretório frágil: {directory}',
      weakDirectoryReason: 'Código aqui estabiliza em {ratio}% nos {files} arquivos tocados. O diretório absorveu {churn} eventos de churn — retrabalho se concentra aqui.',
      tightCouplingTitle: 'Acoplamento alto',
      tightCouplingReason: '{fileA} e {fileB} mudam juntos {rate}% das vezes ({count} mudanças conjuntas). Desacoplar reduziria o custo de retrabalho na área.',
      fixMagnetTitle: '{origin} atrai fixes',
      fixMagnetReason: 'Commits de {origin} representam {codeShare}% das mudanças mas {fixShare}% dos fixes ({disp}× o baseline, {count} fixes na janela). Os padrões de review podem precisar de ajuste para essa origem.',
      hypothesisNote: 'Estes são hipóteses sistêmicas derivadas do histórico de commits. Indicam onde a atenção pode reduzir retrabalho, não quem é responsável.',
    },
    adoption: {
      title: 'Timeline de Entrega com IA',
      subtitle: 'O que mudou neste repositório depois que os commits assistidos por IA começaram.',
      orgTitle: 'Timeline de Entrega com IA',
      orgSubtitle: 'Repositórios onde a adoção de IA foi detectada e como a qualidade de entrega se alterou desde então.',
      orgEmpty: 'Nenhum evento de adoção de IA detectado ainda nesta organização.',
      empty: 'Nenhum evento de adoção de IA detectado. Instale o hook do Iris ou faça commits com atribuição de IA para essa visão aparecer.',
      insufficient: 'Coletando dados: {count} commits com IA até agora (precisa de pelo menos 5 para analisar deltas pré/pós).',
      detected: 'Adoção de IA detectada em {date} ({count} commits com IA)',
      hypothesisNote: 'Os deltas comparam janelas pré-adoção e pós-adoção. Correlação, não causalidade — outras mudanças podem ter acontecido em paralelo.',
      confidence: {
        clear: 'Claro',
        sparse: 'Esparso',
    ...
    toolComparison: {
      ...
      subtitle: 'Sinais de qualidade lado a lado entre as ferramentas de IA usadas no seu código.',
      ...
      thresholdNote: 'Linhas com menos de {threshold} commits ficam marcadas como baixa confiança e vão pro final da lista.',
      noSignificant: 'Nenhuma ferramenta ainda tem commits suficientes para uma comparação significativa (mínimo {threshold}).',
    },
    connect: {
      title: 'Conecte seu primeiro repositório',
      subtitle: 'Tenha seu primeiro insight em menos de 5 minutos. Três comandos curtos no terminal.',
      alreadyConnected: 'Você já tem {count} {repoLabel} conectado. Você ainda pode adicionar mais pela CLI.',
    ...
    repos: {
      ...
      deleteDialog: {
        ...
        description: 'Isso excluirá permanentemente o repositório {name} e todas as suas execuções de análise e métricas. Esta ação não pode ser desfeita.',
        warning: 'Excluir um repositório é irreversível. Todo o histórico de execuções, métricas e insights deste repositório serão removidos permanentemente.',
        ...
        mismatch: 'O texto de confirmação deve corresponder ao nome do repositório',
      },
      detail: {
        metrics: {
          stabilization: 'Estabilização',
        ...
        contributorsCountPlural: '{count} contribuidores na última janela de análise',
    ...
    repoCharts: {
      ...
      aiImpact: {
        title: 'Impacto da IA',
        subtitle: 'Como o código assistido por IA se compara ao humano ao longo do tempo',
      },
      commitMix: {
      ...
      compare: {
        ...
        stabilizationSubtitle: 'Taxa de persistência de arquivos — Humano vs IA',
        durabilityTitle: 'Durabilidade do código',
        durabilitySubtitle: 'Taxa de sobrevivência de linhas no HEAD — Humano vs IA',
        cascadesTitle: 'Cascatas de correção',
        cascadesSubtitle: 'Taxa de gatilho de cascata de correção — Humano vs IA',
      },
    },
    aiExposure: {
      title: 'Exposição a Shadow AI',
      subtitle: 'Quanto código assistido por IA está sendo produzido — e quanto está atribuído.',
      empty: 'Ainda não há dados de origem. Rode a CLI em um repositório para começar a medir.',
      summary: {
        attributed: 'IA Atribuída',
        attributedHint: 'Commits com rastro de co-autor IA (ex: Copilot, Claude, Cursor)',
        estimated: 'IA Estimada',
        estimatedHint: 'Limite superior: commits atribuídos mais commits humanos com padrão de IA',
        gap: 'Gap de Shadow AI',
        gapHint: 'Pontos percentuais entre estimado e atribuído. Maior = mais provável IA oculta.',
        baseline: '{flagged} de {total} commits humanos batem com ≥2 sinais de IA (rajada, diff grande, sucessão rápida, dispersão ampla).',
        noSignal: 'Nenhum sinal de shadow detectado entre os repositórios. A cobertura atribuída reflete o uso real de IA no histórico.',
      },
      table: {
      ...
      install: {
        ...
        description: 'Instale o hook prepare-commit-msg do Iris em {name} para que commits de IA passem a ter atribuição automática.',
      ...
      hypothesisNote: 'Estes números são hipóteses, não verdades. O sinal de shadow marca commits que batem com padrões vistos em trabalho com IA; não prova autoria por IA.',
    },
    team: {
      title: 'Equipe',
    ...
    setup: {
      ...
      errorGithubOrgTaken: 'Esta organização do GitHub já está vinculada a um workspace Iris do qual você não é membro. Peça a um membro existente para te convidar.',
    },
    auditLog: {
    ...
    security: {
      ...
      password: {
        ...
        dialogDescription: 'Digite sua senha atual e escolha uma nova senha segura',
    ...
    account: {
      ...
      danger: {
        ...
        confirmRequired: 'Confirme que você entende que esta ação é irreversível',
        errorGeneric: 'Falha ao excluir a conta',
        success: 'Conta excluída com sucesso',
        ownerWarning: 'Você não pode excluir sua conta enquanto for proprietário de uma ou mais organizações. Transfira a propriedade para outro membro primeiro.',
      },
    },
    auth: {
      signin: {
    ...
    acceptInvite: {
      ...
      fallback: {
        ...
        description: 'Estamos preparando os detalhes do seu convite. Aguarde um momento.',
      },
      errors: {
    ...
    notFound: {
      ...
      description: 'Desculpe, não conseguimos encontrar a página que você procura. Ela pode ter sido removida ou a URL pode estar incorreta.',
  ...
  'es-ES': {
    ...
    home: {
      hero: {
        ...
        description: 'Mide lo que sobrevive, no lo que se entrega. Iris analiza tus repositorios Git y revela si la IA está haciendo tu código más duradero — o solo más voluminoso. Detecta Copilot, Claude, Cursor, Windsurf y otras herramientas de IA automáticamente.',
        ctaPrimary: 'Comenzar',
      ...
      problem: {
        ...
        description: 'Tu equipo adoptó herramientas de IA. Los commits aumentaron. Los PRs son más rápidos. Las métricas tradicionales dicen que todo va bien. Pero no puedes ver lo que se está rompiendo por debajo.',
      ...
      provenData: {
        ...
        description: 'Validado en una organización con 58 repositorios, 3.497 commits y 1.211 PRs fusionados.',
        stat1Label: 'estabilización del código de IA vs código humano',
        stat2Label: 'de los commits "humanos" coinciden con patrones de velocidad de IA',
        stat3Label: 'de acoplamiento detectado en 4 implementaciones de cliente',
      ...
      howItWorks: {
        ...
        runLabel: '2. Ejecutar',
        readLabel: '3. Leer',
        readDescription: 'Recibe un reporte en Markdown + métricas en JSON con delivery pulse, investigación de churn y análisis de impacto de la IA.',
        prLabel: 'Opcional: revisar PRs',
        prDescription: 'Analiza cualquier PR por composición de IA, riesgo de churn y riesgo de cascada. Publica los insights como comentario en el PR.',
      },
      modules: {
        ...
        items: {
          originClassifier: 'Atribución Humano / Asistido por IA / Bot por herramienta (Copilot, Claude, Cursor, Windsurf)',
          codeDurability: 'Tasa de supervivencia de líneas por origen y herramienta',
          correctionCascades: 'Patrones de correcciones en cadena por origen y herramienta',
          ...
          churnInvestigation: 'Detección de cadenas y acoplamiento entre archivos',
      ...
      cta: {
        ...
        description: 'Un comando. Corre localmente. La plataforma en la nube es opcional.',
        copy: 'Copiar',
        copied: '¡Copiado!',
    ...
    faqPage: {
      ...
      subtitle: 'Todo lo que necesitas saber sobre Iris. ¿No encontraste lo que buscabas?',
      questions: {
        whatIsTitle: '¿Qué mide Iris?',
        whatIsAnswer: 'Iris analiza tu historial de Git para revelar señales de calidad de entrega: estabilización, durabilidad del código, cascadas de corrección, brechas de atribución e impacto de la IA. Los reportes son puntuales, no monitoreo en vivo.',
        howWorksTitle: '¿Cómo funciona el análisis?',
        howWorksAnswer: 'Ejecuta la CLI en cualquier repo. Lee commits, PRs y datos de supervivencia de código localmente, y genera un reporte Markdown + métricas JSON. El motor no depende de servicios en la nube.',
        aiToolsTitle: '¿Qué herramientas de IA detecta?',
        aiToolsAnswer: 'Copilot, Claude, Cursor, Windsurf y otros asistentes se detectan vía metadatos de commits, trailers de co-autor y patrones de velocidad. Se pueden agregar herramientas nuevas vía hook prepare-commit-msg.',
        privacyTitle: '¿Iris lee mi código?',
        privacyAnswer: 'El motor corre localmente y solo inspecciona metadatos de Git y diffs. Nada sale de tu máquina, salvo que conectes la plataforma en la nube opcional para agregación entre repos.',
        individualsTitle: '¿Hace ranking o score de devs?',
        individualsAnswer: 'No. Iris está diseñado explícitamente para analizar sistemas, nunca individuos. No hay ranking de productividad, leaderboard por autor, ni score individual.',
        platformTitle: '¿Qué agrega la plataforma en la nube?',
        platformAnswer: 'La plataforma agrega métricas entre repos y a lo largo del tiempo, ofrece dashboards a nivel de organización, detección de cambios y comparación entre repos. La CLI por sí sola es totalmente usable sin ella.',
        installTitle: '¿Cómo instalo?',
        installAnswer: 'Ejecuta el script de instalación (curl -fsSL https://iris.clickbus.com/install.sh | sh) o pipx install iris. Requiere Python 3.11+ y Git.',
        priceTitle: '¿Cuánto cuesta?',
        priceAnswer: 'La CLI es gratuita y open source. La plataforma en la nube está en acceso anticipado con precio por uso — contáctanos para más detalles.',
        contributeTitle: '¿Cómo puedo contribuir o reportar problemas?',
        contributeAnswer: 'El proyecto está en GitHub en RocketBus/clickbus-iris. Issues y PRs son bienvenidos.',
      },
    },
    footer: {
      privacy: 'Privacidad',
      terms: 'Términos',
      copyright: 'Clickbus Iris',
    },
    preferences: {
      language: {
        title: 'Idioma',
    ...
    notFound: {
      ...
      description: 'Lo sentimos, no pudimos encontrar la página que buscas. Puede que haya sido eliminada o que la URL sea incorrecta.',
